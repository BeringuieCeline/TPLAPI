...
public class TestHelper {
    ...
    static TestCar gas() {
        return new TestCar(CarType.GASOLINE);
    }

    static TestCar e20() {
        return new TestCar(CarType.ELECTRIC_20KW);
    }

    static TestCar e50() {
        return new TestCar(CarType.ELECTRIC_50KW);
    }

    static TestCar other() {
        return new TestCar(CarType.OTHER);
    }

    static TestCar e20ChargeNotRequired() {
        return new TestCar(CarType.ELECTRIC_20KW, true);
    }

    static TestCar e50ChargeNotRequired() {
        return new TestCar(CarType.ELECTRIC_50KW, true);
    }
    ...
    static List<TestCar> e20List(int number) {
        return buildList(CarType.ELECTRIC_20KW, false, number);
    }

    static List<TestCar> e50List(int number) {
        return buildList(CarType.ELECTRIC_50KW, false, number);
    }

    static List<TestCar> gasList(int number) {
        return buildList(CarType.GASOLINE, false, number);
    }

    static List<TestCar> e20ChargeNotRequiredList(int number) {
        return buildList(CarType.ELECTRIC_20KW, true, number);
    }

    static List<TestCar> e50ChargeNotRequiredList(int number) {
        return buildList(CarType.ELECTRIC_50KW, true, number);
    }
